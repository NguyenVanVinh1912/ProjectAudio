...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(110, 70, 401, 251))
        ...
        self.widget.setGeometry(QtCore.QRect(0, 440, 621, 401))
        ...
        self.dung_lai.setEnabled(False)
        self.dung_lai.setGeometry(QtCore.QRect(240, 60, 31, 31))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.dung_lai.setFont(font)
        self.dung_lai.setMouseTracking(False)
        self.dung_lai.setTabletTracking(False)
        self.dung_lai.setAcceptDrops(False)
        self.dung_lai.setAutoFillBackground(False)
        ...
        self.dung_lai.setIconSize(QtCore.QSize(18, 26))
        self.dung_lai.setCheckable(False)
        self.dung_lai.setAutoRepeat(False)
        self.dung_lai.setAutoExclusive(False)
        self.dung_lai.setAutoDefault(False)
        self.dung_lai.setDefault(False)
        self.dung_lai.setFlat(False)
        self.dung_lai.setObjectName("dung_lai")
        self.table_list = QtWidgets.QTableWidget(self.widget)
        self.table_list.setGeometry(QtCore.QRect(0, 100, 621, 261))
        ...
        self.dung_lai_2 = QtWidgets.QPushButton(self.widget)
        self.dung_lai_2.setEnabled(False)
        self.dung_lai_2.setGeometry(QtCore.QRect(240, 60, 31, 31))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.dung_lai_2.setFont(font)
        self.dung_lai_2.setMouseTracking(False)
        self.dung_lai_2.setTabletTracking(False)
        self.dung_lai_2.setAcceptDrops(False)
        self.dung_lai_2.setAutoFillBackground(False)
        self.dung_lai_2.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../ProjectPythonAudio - Copy/image/tim_kiem.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dung_lai_2.setIcon(icon8)
        self.dung_lai_2.setIconSize(QtCore.QSize(18, 26))
        self.dung_lai_2.setCheckable(False)
        self.dung_lai_2.setAutoRepeat(False)
        self.dung_lai_2.setAutoExclusive(False)
        self.dung_lai_2.setAutoDefault(False)
        self.dung_lai_2.setDefault(False)
        self.dung_lai_2.setFlat(False)
        self.dung_lai_2.setObjectName("dung_lai_2")
