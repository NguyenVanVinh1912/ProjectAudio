...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dung_lai_3 = QtWidgets.QPushButton(self.widget)
        self.dung_lai_3.setGeometry(QtCore.QRect(590, 330, 41, 41))
        font = QtGui.QFont()
        font.setPointSize(24)
        self.dung_lai_3.setFont(font)
        self.dung_lai_3.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("image/ket_thuc.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dung_lai_3.setIcon(icon8)
        self.dung_lai_3.setIconSize(QtCore.QSize(32, 32))
        self.dung_lai_3.setObjectName("dung_lai_3")
